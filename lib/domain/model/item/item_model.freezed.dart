...
class _ItemModel implements ItemModel {
  const _ItemModel({@JsonKey(name: 'id') required this.id, @JsonKey(name: 'name') required this.name, @JsonKey(name: 'description') required this.description, @JsonKey(name: 'rt_id') required this.rtId, @JsonKey(name: 'item_type') required this.itemType});
