...
mixin _$IplBillModel {
 ...
 String get id;@JsonKey(name: "due_date") String get dueDate;@JsonKey(name: "house_id") String get houseId;@JsonKey(name: "ipl_rate_id") String get iplRateId; int get month; String get penalty;@JsonKey(name: "rt_id") String get rtId; String get status;@JsonKey(name: "total_amount") double get totalAmount; int get year;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,dueDate,houseId,iplRateId,month,penalty,rtId,status,totalAmount,year);

@override
String toString() {
  return 'IplBillModel(id: $id, dueDate: $dueDate, houseId: $houseId, iplRateId: $iplRateId, month: $month, penalty: $penalty, rtId: $rtId, status: $status, totalAmount: $totalAmount, year: $year)';
}
...
@useResult
$Res call({
 String id,@JsonKey(name: "due_date") String dueDate,@JsonKey(name: "house_id") String houseId,@JsonKey(name: "ipl_rate_id") String iplRateId, int month, String penalty,@JsonKey(name: "rt_id") String rtId, String status,@JsonKey(name: "total_amount") double totalAmount, int year
});
...
/// Create a copy of IplBillModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? dueDate = null,Object? houseId = null,Object? iplRateId = null,Object? month = null,Object? penalty = null,Object? rtId = null,Object? status = null,Object? totalAmount = null,Object? year = null,}) {
...
/// Create a copy of IplBillModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? dueDate = null,Object? houseId = null,Object? iplRateId = null,Object? month = null,Object? penalty = null,Object? rtId = null,Object? status = null,Object? totalAmount = null,Object? year = null,}) {
