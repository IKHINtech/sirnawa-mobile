...
mixin _$RondaGroupModel {
 ...
 String get id;@JsonKey(name: 'created_at') DateTime get createdAt;@JsonKey(name: 'updated_at') DateTime get updatedAt;@JsonKey(name: 'rt_id') String get rtId; String get name;@JsonKey(name: 'members') List<RondaGroupMemberModel>? get rondaGroupMembers;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,createdAt,updatedAt,rtId,name,const DeepCollectionEquality().hash(rondaGroupMembers));

@override
String toString() {
  return 'RondaGroupModel(id: $id, createdAt: $createdAt, updatedAt: $updatedAt, rtId: $rtId, name: $name, rondaGroupMembers: $rondaGroupMembers)';
}
...
@useResult
$Res call({
 String id,@JsonKey(name: 'created_at') DateTime createdAt,@JsonKey(name: 'updated_at') DateTime updatedAt,@JsonKey(name: 'rt_id') String rtId, String name,@JsonKey(name: 'members') List<RondaGroupMemberModel>? rondaGroupMembers
});
...
/// Create a copy of RondaGroupModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? createdAt = null,Object? updatedAt = null,Object? rtId = null,Object? name = null,Object? rondaGroupMembers = freezed,}) {
...
class _RondaGroupModel implements RondaGroupModel {
  const _RondaGroupModel({required this.id, @JsonKey(name: 'created_at') required this.createdAt, @JsonKey(name: 'updated_at') required this.updatedAt, @JsonKey(name: 'rt_id') required this.rtId, required this.name, @JsonKey(name: 'members') final  List<RondaGroupMemberModel>? rondaGroupMembers}): _rondaGroupMembers = rondaGroupMembers;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _RondaGroupModel&&(identical(other.id, id) || other.id == id)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&(identical(other.rtId, rtId) || other.rtId == rtId)&&(identical(other.name, name) || other.name == name)&&const DeepCollectionEquality().equals(other._rondaGroupMembers, _rondaGroupMembers));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,createdAt,updatedAt,rtId,name,const DeepCollectionEquality().hash(_rondaGroupMembers));
...
/// Create a copy of RondaGroupModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? createdAt = null,Object? updatedAt = null,Object? rtId = null,Object? name = null,Object? rondaGroupMembers = freezed,}) {
