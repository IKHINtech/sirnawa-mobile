...
mixin _$RondaGroupModel {
 ...
 String get id;@JsonKey(name: 'created_at') DateTime get createdAt;@JsonKey(name: 'updated_at') DateTime get updatedAt;@JsonKey(name: 'rt_id') String get rtId; String get name;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,createdAt,updatedAt,rtId,name);

@override
String toString() {
  return 'RondaGroupModel(id: $id, createdAt: $createdAt, updatedAt: $updatedAt, rtId: $rtId, name: $name)';
}
...
@useResult
$Res call({
 String id,@JsonKey(name: 'created_at') DateTime createdAt,@JsonKey(name: 'updated_at') DateTime updatedAt,@JsonKey(name: 'rt_id') String rtId, String name
});
...
/// Create a copy of RondaGroupModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? createdAt = null,Object? updatedAt = null,Object? rtId = null,Object? name = null,}) {
...
class _RondaGroupModel implements RondaGroupModel {
  const _RondaGroupModel({required this.id, @JsonKey(name: 'created_at') required this.createdAt, @JsonKey(name: 'updated_at') required this.updatedAt, @JsonKey(name: 'rt_id') required this.rtId, required this.name});
...
/// Create a copy of RondaGroupModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? createdAt = null,Object? updatedAt = null,Object? rtId = null,Object? name = null,}) {
