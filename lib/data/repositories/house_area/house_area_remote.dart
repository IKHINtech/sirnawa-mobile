import 'package:sirnawa_mobile/data/repositories/house_area/house_area_repository.dart';
...
class HouseAreaRepositoryRemote implements HouseAreaRepository {
  HouseAreaRepositoryRemote({required HousingAreaService housingAreaService})
  ...
  @override
  Future<Result<void>> createHouseArea(HousingAreaModel houseArea) async {
    try {
